<?php
  ...
  define("colonne_2", "n_notif");
  define("colonne_3", "notification");
      ...
      if(empty($errors)==true){
         ...
         foreach ($rawData as $key => $row) {
          ...
          if($error != ""){
            ...
            copy("./notifs.csv","./notifs".time().".csv");
            move_uploaded_file($file_tmp,"./notifs.csv");
         
            echo "Les notifs ont été correctement importés! :)";
          }
